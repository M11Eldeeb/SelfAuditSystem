...
export async function createHistoricalInternalAudit(
  ...
  revalidatePath(`/admin/results/internal-audit/${branchId}`);
  return { success: "Historical internal-audit result added." };
}

export async function deleteHistoricalInternalAudit(id: string, branchId: string): Promise<{ error?: string }> {
